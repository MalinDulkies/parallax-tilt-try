...
export class Tilt {
  ...
  public constrainToRange = (value: number, rangeMin: number, rangeMax: number): number =>
  ...
  private updateTiltLimits = (props: TiltProps): void => {
    ...
    this.tiltAngleX = this.constrainToRange(this.tiltAngleX, -TILT_ANGLE_CONSTRAINT, TILT_ANGLE_CONSTRAINT);
    this.tiltAngleY = this.constrainToRange(this.tiltAngleY, -TILT_ANGLE_CONSTRAINT, TILT_ANGLE_CONSTRAINT);
